...
class HorizontalCarouselRecyclerView(
    ...
    private val activeColor by lazy { ContextCompat.getColor(context, R.color.purple_700) }
    private val inactiveColor by lazy { ContextCompat.getColor(context, R.color.purple_200) }
